...
exports._deliverNotify = function (package, callback) {
  ...
  request({url: url, json: true, method: 'POST', body: JSON.stringify(package)}, wrapper(callback));
};
...
exports._orderQuery = function (query, callback) {
  ...
  request({url: url, json: true, method: 'POST', body: JSON.stringify(query)}, wrapper(callback));
};
