...
exports._uploadNews = function (news, callback) {
  ...
  request({url: url, json: true, method: 'POST', body: JSON.stringify(news)}, wrapper(callback));
};
...
exports._uploadMPVideo = function (opts, callback) {
  ...
  request({url: url, json: true, method: 'POST', body: JSON.stringify(opts)}, wrapper(callback));
};
