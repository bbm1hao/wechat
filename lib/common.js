 ...
 */
var API = function (appid, appsecret, token, proxy) {
  this.appid = appid;
...
API.prototype.getAccessToken = function (callback) {
  ...
  this.request({url: url, json: true}, wrapper(function (err, data, res) {
    if (err) {
      return callback(err);
    }
...
API.prototype._getMedia = function (mediaId, callback) {
  ...
  this.request({url: url}, wrapper(function (err, data, res) {
