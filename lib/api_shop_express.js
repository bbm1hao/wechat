...
exports._addExpressTemplate = function (express, callback) {
  ...
  require('./request').module({url: url, json: true, method: 'POST', body: JSON.stringify(express)}, wrapper(callback));
};
...
exports._deleteExpressTemplate = function (templateId, callback) {
  ...
  require('./request').module({url: url, json: true, method: 'POST', body: JSON.stringify(data)}, wrapper(callback));
};
...
exports._updateExpressTemplate = function (template, callback) {
  var url = this.merchantPrefix + 'express/del?access_token=' + this.token.accessToken;
  require('./request').module({url: url, json: true, method: 'POST', body: JSON.stringify(template)}, wrapper(callback));
};
...
exports._getAllExpressTemplates = function (callback) {
  ...
  require('./request').module({url: url, json: true}, wrapper(callback));
};
